...
public class CokerUnitContainer extends MultiblockAwareGuiContainer{
	...
	public static CokerUnitContainer makeServer(MenuType<?> type, int id, Inventory player, MultiblockMenuContext<CokerUnitLogic.State> ctx){
	...
	public static CokerUnitContainer makeClient(MenuType<?> type, int id, Inventory player){
		return new CokerUnitContainer(clientCtx(type, id), player, new ItemStackHandler(CokerUnitLogic.Inventory.values().length),
