	...
	protected List<AABB> getShape(BlockPos posInMultiblock){
		...
		if(x == 0){
			...
			if(y == 0){
				...
				if(z == 1) AABBUtils.box16(main, 2, 12, 0, 16, 16, 16);
				if(z == 3) AABBUtils.box16(main, 2, 12, 0, 16, 16, 4);
			}
			
			// Top half
			if(y == 1){
				if(z == 0) AABBUtils.box16(main, 2, 0, 8, 16, 12, 16);
				if(z == 1) AABBUtils.box16(main, 2, 0, 0, 16, 12, 16);
				if(z == 3) AABBUtils.box16(main, 2, 0, 0, 16, 12, 4);
			}
		}
		...
		// Big tank
		{
			...
			if(y == 0){
				if(z == 0){
					if(x == 1) AABBUtils.box16(main, 2, 5, 1, 6, 16, 5);
					if(x == 2) AABBUtils.box16(main, 10, 5, 1, 14, 16, 5);
				}
				if(z == 1){
					if(x == 1) AABBUtils.box16(main, 2, 5, 16, 6, 16, 16);
					if(x == 2) AABBUtils.box16(main, 10, 5, 16, 16, 16, 16);
				}
				if(x == 2){
